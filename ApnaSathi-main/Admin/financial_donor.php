...
$sql = "SELECT * FROM supporter_registration";
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<tr id='row-{$row['user_id']}'>
                    ...
                    <td>{$row['supporter_mobile']}</td>
                    <td>{$row['supporter_birthdate']}</td>
                    <td>{$row['age']}</td>
                    <td>{$row['supporter_type']}</td>
                    <td>{$row['foundation_type']}</td>
                   
                    <td class='status-display'>{$row['application_status']}</td>
                    <td>{$row['supporter_email']}</td>
                    <td>
