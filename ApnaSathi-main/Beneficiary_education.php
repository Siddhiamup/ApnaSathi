...
<head>
    ...
    <script src="./assests/js/Beneficiary_Education.js"></script>
...
<body>
    ...
    <div class="img-bg">
        ...
        <div class="block">
            ...
            <main id="register">
                <h2 class="text-center "> Student Regestration Form</h2>
                    ...
                    <form id="myF" method="POST" enctype="multipart/form-data" name="reg">
                        ...
                        <fieldset id="p2" style="display:none;">
                            <div class="mb-3">
                                ...
                                <input type="file" name="Signature" enctype="multipart/form-data" required
                                    class="form-control w-50 m-auto">
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="lbl">Income certificate:</label>
                                <input type="file" name="incomeCerti" enctype="multipart/form-data" required
                                    class="form-control w-50 m-auto">
                            </div>
                            <!--<div class="mb-3">
                                <label>Which type of help do you need?</label><br>
                                <input type="radio" id="scholarship" value="Scholarship" class="help" name="help">
                                <label for="scholarship">Scholarship for Education</label><br>
                                <input type="radio" id="healthcare" value="HealthCare" class="help" name="help">
                                <label for="healthcare">HealthCare Setup</label><br>
                                <input type="radio" id="orphanage" value="Orphanage" class="help" name="help">
