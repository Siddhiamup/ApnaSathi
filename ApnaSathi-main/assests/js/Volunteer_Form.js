document.addEventListener("DOMContentLoaded", () => {
    ...
    const validatePage2 = () => {
        ...
        const slot = form.slot.value.trim();
        ...
        if (aadhar === "") {
            errorMessages.push("The 'Aadhar' field is required. Please enter your Aadhar number.");
            valid = false;
        }
    
        if (slot === "") {
            errorMessages.push("The 'Availability Slot' is required. Please select your availability.");
            valid = false;
        }
